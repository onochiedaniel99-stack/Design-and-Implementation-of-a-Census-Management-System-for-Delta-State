...
// Function to update birth LGA dropdown
function updateBirthLGAs() {
    const stateSelect = document.getElementById("state_of_birth");
    const lgaSelect = document.getElementById("lga_of_birth");
    const selectedState = stateSelect.value;
    
    // Clear previous LGAs
    lgaSelect.innerHTML = '<option value="">Select LGA of Birth</option>';
...
document.addEventListener('DOMContentLoaded', function() {
    // Populate state dropdowns if they're empty
    const stateSelects = ['state_of_origin', 'state_of_birth'];
    stateSelects.forEach(function(id) {
